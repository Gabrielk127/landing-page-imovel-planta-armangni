...
const Header: React.FC = () => {
  ...
  "
              >
                Crédito{" "}
                <span className="text-custom-text-title">Inteligente</span> Na
                Compra De Um Imóvel Na{" "}
                <span className="text-custom-text-title">Planta</span>.
                <br />
                <span className="text-custom-text-title">Maximize</span> Seus
                Resultados!
              </h1>
              <p
            ...
            "
              >
                A compra de um imóvel na planta representa uma realização,
                também, um ótimo investimento, a contratação com antecedência de
                um crédito inteligente no ato desta compra traz segurança para
                entrega das chaves e maximiza seus resultados.
              </p>
            </div>
